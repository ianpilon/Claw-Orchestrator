        ...
        <DialogContent className="sm:max-w-2xl">
          <div className="p-2">
            <div className="p-2 text-sm space-y-4 overflow-y-auto max-h-[80vh]">
              <h2 className="text-base font-semibold flex items-center gap-2">About Claw Orchestrator</h2>
              <p>
                <strong>Claw Orchestrator</strong> is an{' '}
              ...
              <p>
                ...
                <strong>threat assessments</strong>, Claw Orchestrator helps you collect, visualize, and
                understand fragmented data points in a structured and interactive way.
              </p>

              <h3 className="font-semibold">What Claw Orchestrator Does</h3>
              ...
              <h3 className="font-semibold">Why Use Claw Orchestrator?</h3>
              <ul className="list-disc list-inside space-y-1">
                <li>
              ...
              <p>
                Claw Orchestrator is designed for <strong>professionals</strong> who need{' '}
